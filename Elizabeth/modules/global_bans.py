...
from Elizabeth import STRICT_GBAN  # LOGGER,
...
def gbanstat(update, context):
    ...
    if len(args) > 0:
        if args[0].lower() in ["on", "yes"]:
            ...
            update.effective_message.reply_text(
                "I've enabled SpamProtection in this group. This will help protect you "
                "from spammers, unsavoury characters, and the biggest trolls."
            )
        elif args[0].lower() in ["off", "no"]:
            sql.disable_gbans(update.effective_chat.id)
            update.effective_message.reply_text(
                "I've disabled SpamProtection in this group. SpamShield wont affect your users "
        ...
        update.effective_message.reply_text(
            ...
            "When True, Any SpamProtection that happen will also happen in your group. "
    ...
    if cas_banned or spmban or is_gbanned:
        ...
        if is_gbanned:
            ...
            if user.reason:
                ...
                text += "\nAppeal at SupportChat if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
__help__ = """
*Admin only:*
 × /spamprotection <on/off/yes/no>: Will disable or enable the effect of Spam protection in your group.

Spamprotection uses Combot Anti Spam, @Spamwatch API and Global bans to remove Spammers as much as possible from your chatroom!
