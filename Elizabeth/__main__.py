...
Join Our [Support group](https://t.me/) If You wanna Report Issue ðŸ™‚

I'm here to make your group management fun and easy!
I have lots of handy features â˜ºï¸ such as :
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group ðŸ‘¥", url="t.me/{dispatcher.bot.username}?startgroup=true"
        ),
        InlineKeyboardButton(
            text="Add your button ðŸš«", url="Space for a button"
        ),
    ]
]
...
buttons += [
    [
        ...
        InlineKeyboardButton(
            text="Fork Me ðŸŽ—ï¸", url="https://github.com/swatv3nub/MissElizabethRobot"
        ),
    ]
]
...
*Main* commands available:
 ...
 Ã— /help <module name>: PM's you info about that module.
 Ã— /settings: in PM: will send you your settings for all supported modules.
...
*DEV USERS*
Ã— /gitpull: Pull latest update.
Ã— /reboot: Restart the bot.
...
Ã— /speedtest: Start a speedtest from my server.
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="â¬…ï¸Go Backâ¬…ï¸", callback_data="help_back"
                            )
                        ]
                    ]
                ),
